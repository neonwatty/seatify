      ...
      <div className="auth-brand-panel">
        <div className="auth-brand-content">
          ...
          <h2 className="auth-brand-tagline">
            Create beautiful seating arrangements
          </h2>
          <p className="auth-brand-description">
            Effortlessly plan weddings, galas, and events with our intuitive
            drag-and-drop seating chart maker. Smart relationship handling included.
          </p>
        </div>
      ...
      <div className="auth-form-panel">
        <div className="auth-container">
          <div className="auth-header">
            ...
            <h1>Welcome back</h1>
            <p>Sign in to access your seating charts</p>
          </div>
